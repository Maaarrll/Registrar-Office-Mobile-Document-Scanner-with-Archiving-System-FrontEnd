...
public class ProfilingCameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiling_camera);
    ...
    private void takePhoto() {
        ...
        Toast.makeText(this, "Capturing document...", Toast.LENGTH_SHORT).show();

        File photoFile = new File(
                getExternalFilesDir(null),
                "profiling_document_photo.jpg"
        );
